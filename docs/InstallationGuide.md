...
| OPS_IDP_URL                          | O (M for IDP integration)         | -                                                | [https://infra-keycloak.k8s.sdntest.qubership.org](https://github.com/Netcracker/qubership-env-checker) | URL to infra-keycloak. If IDP parameters are not defined then access to Env Checker is allowable via Jupiter default token                                     |
